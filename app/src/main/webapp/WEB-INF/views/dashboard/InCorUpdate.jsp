...
pageEncoding="UTF-8"%> 
<div class="modal fade bs-example-modal-lg2 show" tabindex="-1"
	role="dialog" style="display: none;" aria-modal="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">

			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">입고처수정</h4>
				<button type="button" class="close" data-dismiss="modal">
					<span aria-hidden="true">×</span>
				</button>
			</div>
			<div class="modal-body">
						<form id="InCorUpdate"novalidate="">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-round btn-success" onClick="InCorUpdate()">수정</button>
				</div>
			</form>
			</div>
		</div>
