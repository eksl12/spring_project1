...
<div class="x_title">
<h2>입고처등록 <small>sub title</small></h2>
...
<div class="col-md-6 col-sm-6">
<input class="form-control" name="charge" data-validate-length-range="3,15" type="text"></div>
</div>
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">계산서메일</label>
<div class="col-md-6 col-sm-6">
<input class="form-control" name="billMail"  type="email"></div>
</div>
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">계산서메일확인</label>
<div class="col-md-6 col-sm-6">
<input class="form-control" type="email" name="confirm_email" data-validate-linked="billMail" ></div>
</div>
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">휴대폰</label>
<div class="col-md-6 col-sm-6">
<input class="form-control" type="tel" name="number"  data-validate-length-range="8,20"></div>
</div>
<div class="field item form-group">
...
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">사업자번호 </label>
<div class="col-md-6 col-sm-6">
<input class="form-control" type="number" name="corNumber" data-validate-minmax="10,100" ></div>
</div>
<div class="ln_solid">
